...
const myComponentCss = ":host{display:inline-block;border:4px solid crimson;padding:5px}";
...
class MyComponent {
    ...
    render() {
        return hAsync("div", { key: '7fa8334d28c1fe03b0c459bce3248815cc730135' }, "Testing :host styles with Declarative Shadow DOM enabled");
    }
